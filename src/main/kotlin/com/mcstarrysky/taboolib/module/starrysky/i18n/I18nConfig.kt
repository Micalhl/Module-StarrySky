package com.mcstarrysky.taboolib.module.starrysky.i18n

import com.mcstarrysky.taboolib.module.starrysky.config.YamlUpdater
...
class I18nConfig(private val locale: String) {
    ...
    private val config: Configuration by unsafeLazy {
        YamlUpdater.loadAndUpdate("${I18n.path}/$locale.yml", updateExists = false)
    }
